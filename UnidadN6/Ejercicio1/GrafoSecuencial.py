...
if __name__ == '__main__':
    ...
    graf= GrafoSec(vert, aristas)

    print('Nodos adyacentes del vertice 1= ', graf.Adycente(1))
    print('Grado del nodo 2= ', graf.grado(2))
    print('Recorrido en profundidad con el nodo 1 de inicio= ',graf.RecorridoenProfundidad(1))
    if graf.Conexo():
        print('El grafo si es conexo' )
    else:
        print('El grafo NO es conexo')

    print('Camino Minimo entre los vertices 3 y 6: ', graf.MinimoCamino(3,6))
    graf.grafico(vert, aristas)
